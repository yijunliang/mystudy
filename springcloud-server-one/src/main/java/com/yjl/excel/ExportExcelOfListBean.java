 ...
 * @param <T>
 */
public class ExportExcelOfListBean<T> extends Export {
    // excle导出名称
    ...
    // 构造函数
    public ExportExcelOfListBean(String fileName, String[] heads, String[] cols, List<T> list, OutputStream out) {
    ...
    // 构造函数 带数字类型
    public ExportExcelOfListBean(String fileName, String[] heads, String[] cols, List<T> list, int[] numerics, OutputStream out) {
        this.fileName = fileName;
        this.heads = heads;
        this.cols = cols;
        this.list = list;
